...
class DeleteHandler(BaseHandler):
    ...
    def post(self):
        ...
        order_models = self.model_config.filter_all(OrderModel, user_id=self.session['user_id'], status=OrderModel.STATUS_CART,
        ...
        order_models = self.model_config.all(OrderModel, user_id=self.session['user_id'], status=OrderModel.STATUS_CART)
        res = {
